...
A **governance meeting** evolves the roles. You capture tensions as discussions, then turn the agreed changes into proposals (see Step 7). A simple template uses a free-note round and a discussions step.

A **tactical meeting** coordinates the work. A useful template combines the **Checklist**, **Indicators**, **Tasks**, and **Discussions** steps so each role reviews its recurring actions, metrics, and next steps.
...
1. Capture a tension as a **discussion** within the relevant role.
