...
To change where a role sits, open it and choose **Move** in its actions menu, then pick the role it moves into. **Duplicate** works the same way and copies the role with its sub-roles and members. In the org chart, dragging a role into another one does the same thing.
...
<Callout type="info" title="Restoring">
  ...
  in the [History](/en/docs/history), or by opening the archived role and selecting Restore. The
