...
Holaspirit is a Holacracy and governance platform, now published under the Talkspirit brand. Rolebase can import your Holaspirit data including roles, members, and their relationships.
...
- **API import** lets developers use the GraphQL API to programmatically create roles and members from any data source. See the [Using the API](/en/developers/use-the-api) guide.
