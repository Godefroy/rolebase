...
- [Create a proposal](/en/docs/proposals) to decide together and apply org chart changes when it is approved.
- [Use discussions](/en/docs/threads) to discuss proposals before recording decisions.
...
- [Open the history](/en/docs/history) to see the org chart changes applied by a decision, and undo one.
