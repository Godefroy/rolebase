...
The export page offers the role to capture, the image width and the view selector, with its **Folded** and **Show members** options described in [the org chart](/en/docs/org-chart). The preview shows exactly what the file will contain, and the page address keeps these settings, to share or come back to.
