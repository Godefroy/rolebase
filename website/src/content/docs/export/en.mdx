...
In addition to data export, you can also export a visual image of your org chart as a PNG file with a transparent background, ready to be embedded in your documents and presentations. Open the org chart view and click the **Export (PNG)** button. The **Show members and sub-roles** option controls whether the image displays every member and nested role, or only the level of detail visible in the preview.
