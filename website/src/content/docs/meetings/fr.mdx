...
## Modifications de l'organigramme pendant une réunion

Quand des rôles ou leurs membres changent pendant une réunion, la page de la réunion liste ces modifications sous **Actions pendant la réunion**. Elles figurent aussi dans l'[historique](/fr/docs/history), où elles restent annulables.
