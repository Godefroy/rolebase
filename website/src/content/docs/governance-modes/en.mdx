...
description: 'Compare the Free, Agile and Strict governance modes to decide who edits your org chart, who assigns members to roles, and which changes need a proposal.'
order: 4.5
---
...
- Every change to the org chart lands in the [history](/en/docs/history), where it stays undoable by anyone the mode allows to make that same change.
