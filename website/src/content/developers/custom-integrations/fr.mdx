...
- Les **clés API** peuvent être créées depuis la page **Paramètres > Clés API** dans l'application. Elles fournissent un accès programmatique limité à une organisation spécifique.
