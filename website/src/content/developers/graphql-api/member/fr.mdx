---
title: 'member'
description: "Membre, représente un membre d'une organisation. Les membres peuvent être affectés à des rôles, et participer à des réunions et des tâches."
...
| `archivedAt` | `Timestamp` | Date d'archivage du membre ; null si actif |
| `createdAt` | `Timestamp` | Date de création du membre |
