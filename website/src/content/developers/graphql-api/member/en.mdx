---
title: 'member'
description: "Member, represents a member of an organization. Members can be assigned to roles, and participate in meetings and tasks."
...
| `archivedAt` | `Timestamp` | When the member was archived; null if active |
