...
description: "Organization Subscription, tracks the subscription plan, payment status, and Stripe integration details for an organization."
...
| `archivedAt` | `Timestamp` | When the subscription was archived; null if active |
