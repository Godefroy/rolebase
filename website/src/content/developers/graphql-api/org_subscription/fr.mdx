---
title: 'org_subscription'
description: "Abonnement d'organisation, suit le plan d'abonnement, le statut de paiement et les détails d'intégration Stripe pour une organisation."
...
| `createdAt` | `Timestamp` | Date de création de l'abonnement |
| `archivedAt` | `Timestamp` | Date d'archivage de l'abonnement ; null si actif |
