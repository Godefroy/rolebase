---
title: 'task'
description: "Create to-dos in a circle, assign them to members and track them with statuses and due dates. See the task statuses, fields, queries and mutations."
category: 'tasks'
---
