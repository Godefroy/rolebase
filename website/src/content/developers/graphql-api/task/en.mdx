---
title: 'task'
description: "Task, represents a task or to-do item in Rolebase. Tasks are associated with circles, can be assigned to members, and support tracking progress with statuses and due dates."
category: 'tasks'
---
...
| `archivedAt` | `Timestamp` | When the task was archived; null if active |
...
<Callout type="info">
  ...
  [task_view](/en/developers/graphql-api/task_view) entity.
</Callout>
