---
title: 'task'
description: "Tâche, représente une tâche ou un élément à faire dans Rolebase. Les tâches sont associées à des cercles, peuvent être assignées à des membres et permettent le suivi de la progression avec des statuts et des dates d'échéance."
category: 'tasks'
---
...
| `archivedAt` | `Timestamp` | Date d'archivage de la tâche ; null si actif |
...
<Callout type="info">
  ...
  [task_view](/fr/developers/graphql-api/task_view).
</Callout>
