---
title: 'thread_activity_reaction'
description: "Réaction d'activité de discussion, représente une réaction emoji à une activité de discussion. Les réactions permettent aux membres d'exprimer des réponses rapides aux messages sans créer de nouvelles activités."
category: 'threads'
---
...
| `memberId` | `uuid` | Référence au membre qui a ajouté la réaction |
