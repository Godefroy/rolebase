...
description: "Thread Activity Reaction, represents an emoji reaction to a thread activity. Reactions allow members to express quick responses to messages without creating new activities."
category: 'threads'
---
...
| `memberId` | `uuid` | Reference to the member who added the reaction |
