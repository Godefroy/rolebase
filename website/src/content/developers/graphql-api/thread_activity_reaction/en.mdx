...
description: "Let members answer a thread message with an emoji instead of writing a new one. See the fields, relationships, queries, mutations and permissions."
category: 'threads'
---
