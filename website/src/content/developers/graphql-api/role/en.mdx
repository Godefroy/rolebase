---
title: 'role'
description: "Each circle in the org chart relies on a role, which defines its purpose, domain and accountabilities. See the role fields, queries and mutations."
...
| `archivedAt` | `Timestamp` | When the role was archived; null if active |
