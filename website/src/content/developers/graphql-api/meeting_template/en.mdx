...
description: "A reusable template sets the steps and flow of a type of meeting, so it keeps the same format from one meeting to the next. See its fields and queries."
category: 'meetings'
---
...
| `archivedAt` | `Timestamp` | When the template was archived; null if active |
