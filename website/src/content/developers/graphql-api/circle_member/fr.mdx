---
title: 'circle_member'
description: "Membre de cercle, représente une relation d'appartenance entre un membre et un cercle, avec suivi du statut d'association et de l'historique."
