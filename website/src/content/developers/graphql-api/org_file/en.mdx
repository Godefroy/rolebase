---
title: 'org_file'
description: "Attach a stored file to an organization so its members can view it. If you remove the link, the file stays stored. See the fields, queries and permissions."
...
| `createdAt` | `Timestamp` | When the file association was created |
