...
description: "Messages, polls and references to other entities make up the content of a discussion thread. See the activity types, fields and GraphQL examples."
category: 'threads'
---
...
- `reactions` — Reactions to this activity (see [thread_activity_reaction](/en/developers/graphql-api/thread_activity_reaction))
