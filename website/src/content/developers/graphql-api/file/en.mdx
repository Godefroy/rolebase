---
title: 'file'
description: "Store a member’s profile picture or a file attached to an organization in a storage bucket. See the bucket settings, fields, queries and access rules."
category: 'other'
---
