---
title: 'file'
description: "File, represents a stored file in Rolebase. Files can be associated with organizations and members for purposes such as profile pictures, document storage, and attachments."
category: 'other'
---
