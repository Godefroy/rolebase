---
title: 'file'
description: "Stockez dans un bucket la photo de profil d’un membre ou un fichier lié à une organisation. Retrouvez les réglages des buckets, champs, requêtes et droits."
category: 'other'
---
