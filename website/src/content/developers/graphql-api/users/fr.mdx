---
title: 'users'
description: "Utilisateurs, représente les comptes utilisateur dans Rolebase, gérés par Hasura Auth. Contient les informations de profil, les détails d'authentification et les relations avec les organisations et les rôles."
category: 'other'
---
...
- `apps` — Applications connectées de l'utilisateur (voir [user_app](/fr/developers/graphql-api/user_app))
