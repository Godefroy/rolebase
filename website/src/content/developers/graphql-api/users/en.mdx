---
title: 'users'
description: "Users, represents user accounts in Rolebase, managed by Hasura Auth. Contains profile information, authentication details, and relationships to organizations and roles."
category: 'other'
---
...
- `apps` — User's connected applications (see [user_app](/en/developers/graphql-api/user_app))
