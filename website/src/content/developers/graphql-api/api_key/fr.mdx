---
title: 'api_key'
description: "Donnez à une application externe un accès programmatique à l’API GraphQL de Rolebase avec une clé. Retrouvez ses champs, requêtes et permissions."
category: 'other'
---
