---
title: 'api_key'
description: "Give an external application programmatic access to the Rolebase GraphQL API with a key. See its fields, queries, mutations and who can manage it."
category: 'other'
---
...
| `lastUsedAt` | `Timestamp` | When the API key was last used to authenticate; null if never used |
| `archivedAt` | `Timestamp` | When the API key was archived; null if active |
