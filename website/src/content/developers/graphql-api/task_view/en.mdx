---
title: 'task_view'
description: "Task View, represents a custom view of tasks in Rolebase. Task views allow users to organize and filter tasks flexibly, supporting different task management methodologies like Kanban or Scrum."
category: 'tasks'
---
