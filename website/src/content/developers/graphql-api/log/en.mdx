---
title: 'log'
description: "Each entity change and user action leaves a log entry, which keeps the organization history and lets members undo the action. See fields and examples."
category: 'other'
---
