---
title: 'user_app'
description: "List the calendar apps a user has connected, Google Calendar or Microsoft 365, with their public settings. See the app types, fields and permissions."
category: 'other'
---
...
| `createdAt` | `Date` | When the app connection was created |
| `archivedAt` | `Timestamp` | When the app connection was archived; null if active |
