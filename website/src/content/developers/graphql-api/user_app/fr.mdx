---
title: 'user_app'
description: "Application utilisateur, représente une application ou intégration connectée d'un utilisateur dans Rolebase. Suit les paramètres d'application, les préférences et les détails d'authentification pour les services tiers comme Google Calendar et Microsoft 365."
category: 'other'
---
