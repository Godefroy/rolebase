...
description: "Thread Extra Member, represents an additional member invited to participate in a thread beyond the default circle participants. Enables cross-circle collaboration by extending thread access."
category: 'threads'
---
