---
title: 'meeting_step'
description: "Each agenda item of a meeting is a step for notes, discussions, the checklist, indicators or tasks. See the step types, fields, queries and mutations."
category: 'meetings'
---
