---
title: 'meeting'
description: "Meeting, represents a scheduled meeting within a circle. Meetings support structured steps, attendee tracking, and video conferencing integration, and can be one-time or part of a recurring series."
category: 'meetings'
---
...
| `archivedAt` | `Timestamp` | When the meeting was archived; null if active |
