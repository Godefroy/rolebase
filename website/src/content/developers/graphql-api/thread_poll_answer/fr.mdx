...
description: "Enregistrez le vote de chaque membre à un sondage d’une discussion, sous forme de points donnés à chaque choix. Retrouvez champs, requêtes et mutations."
category: 'threads'
---
