---
title: 'thread_poll_answer'
description: "Réponse de sondage de discussion, représente la réponse d'un membre à un sondage dans une activité de discussion. Les réponses de sondage permettent aux membres de voter ou de fournir des réponses structurées aux questions posées dans les sondages de discussion."
category: 'threads'
---
...
| `memberId` | `uuid` | Référence au membre qui a soumis la réponse |
