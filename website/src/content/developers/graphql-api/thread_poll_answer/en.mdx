...
description: "Store each member’s vote on a poll posted in a discussion, as the points given to each choice. See the fields, relationships, queries and mutations."
category: 'threads'
---
