...
description: "Thread Poll Answer, represents a member's response to a poll in a thread activity. Poll answers allow members to vote or provide structured responses to questions posed in thread polls."
category: 'threads'
---
...
| `memberId` | `uuid` | Reference to the member who submitted the answer |
