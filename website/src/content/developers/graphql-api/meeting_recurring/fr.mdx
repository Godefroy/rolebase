---
title: 'meeting_recurring'
description: "Réunion récurrente, définit la planification, le modèle et les paramètres d'une série de réunions récurrentes au sein d'un cercle."
category: 'meetings'
---
...
| `archivedAt` | `Timestamp` | Date d'archivage de la configuration récurrente ; null si actif |
