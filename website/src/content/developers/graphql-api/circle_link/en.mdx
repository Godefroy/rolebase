---
title: 'circle_link'
description: "Invite a circle into another one outside the parent-child hierarchy, so its leaders take part in the host circle. See the fields and GraphQL examples."
