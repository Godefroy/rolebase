...
L'[élection sans candidat](/fr/blog/election-without-candidate) formalise cette attribution quand plusieurs personnes conviennent pour un rôle. Pour les rôles d'animation élus par le cercle, comme le facilitateur ou le secrétaire, voir la [réunion de gouvernance](/fr/blog/governance-meeting).
