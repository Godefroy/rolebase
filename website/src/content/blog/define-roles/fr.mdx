...
<FaqItem question="Comment définir les rôles et responsabilités d’une équipe ?">

Listez le travail récurrent que l’équipe fait déjà, puis regroupez-le en rôles nommés d’après une responsabilité plutôt que d’après un métier. Donnez à chaque rôle une raison d’être et trois à sept redevabilités, attribuez-le à une seule personne dans la réunion qui le crée, et révisez-le quand quelqu’un soulève une tension. Pour réunir tous les rôles dans un document partagé, partez d’une [fiche de rôles et responsabilités](/fr/blog/roles-responsibilities-template) avec une entrée par rôle.
