---
title: 'The dynamic org chart, or the org chart of the future'
h1: 'The dynamic organisational chart, or the org chart of the future'
summary: 'A 21st century business needs an org chart that is proactive, decentralised, still connected to the whole organisation, and that makes every member a leader.'
date: 2026-01-23
update: 2026-09-13
image: './thumbnail.jpg'
...
Click a role to zoom into its sub-roles, and drag to move around.

Circles are one way to draw this structure. Rolebase also displays the same roles as a top-down hierarchical tree, with each role in a card under its parent role and the people who fill it listed inside. Most people already know this layout from traditional org charts. When you switch views, only the drawing changes. The roles, their accountabilities and their members stay the same.

Here is an example organization displayed as a hierarchical tree.
