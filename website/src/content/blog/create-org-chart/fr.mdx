...
Une fois les informations réunies, choisissez le type d’organigramme. Chaque [type d’organigramme](/fr/blog/org-chart-types) répond à une question différente : l’arbre hiérarchique montre qui dépend de qui, l’organigramme fonctionnel quel service fait quel travail, l’organigramme matriciel qui travaille pour deux responsables, et l’organigramme circulaire quelle équipe en contient une autre. Prenez celui qui répond à la question que vos équipes posent le plus souvent, puis vérifiez qu’il ressemble à votre fonctionnement réel. Dans Rolebase, vous pouvez afficher vos rôles en cercles, en arbre hiérarchique ou en trombinoscope, et passer d’une vue à l’autre sans rien redessiner.
...
Vous pouvez réaliser un organigramme avec Word, Whimsical, Figma, par n'importe quel moyen graphique ou dans certains SIRH. Réaliser [un organigramme sur Word](/fr/blog/org-chart-word) avec SmartArt prend une dizaine de minutes, moins encore en partant d’un modèle à télécharger. Cependant celui-ci ne sera pas interactif et sa mise à jour sera souvent centralisée vers une seule personne.
