...
summary: 'Construisez un organigramme lisible en quelques clics, partagez-le à l''équipe et gardez-le à jour quand les rôles bougent. Les outils gratuits y sont comparés.'
date: 2023-08-09
update: 2026-09-13
image: './thumbnail.jpg'
similarPosts:
...
Une fois les informations réunies, choisissez le type d’organigramme. Les plus courants sont :

- l’organigramme hiérarchique, ou en arbre, qui place chaque poste sous celui dont il dépend
- l’organigramme fonctionnel, qui regroupe les postes par fonction (finance, ventes, production)
- l’organigramme matriciel, qui ajoute une seconde ligne de rattachement, par projet ou par marché
- l’organigramme horizontal, qui se lit de gauche à droite et convient aux structures à peu de niveaux
- l’organigramme circulaire, qui imbrique les équipes les unes dans les autres

Choisissez le type qui ressemble à votre fonctionnement réel. L’[organigramme en arbre](/fr/blog/hierarchy-chart) convient bien à une petite entreprise qui a peu de niveaux. Une entreprise où les équipes projet croisent les services demande un [organigramme matriciel](/fr/blog/matrix-organizational-structure). Les cercles conviennent à une organisation où des équipes en contiennent d’autres et où une personne tient souvent plusieurs rôles. Dans Rolebase, vous pouvez afficher vos rôles en cercles, en arbre hiérarchique ou en trombinoscope, et passer d’une vue à l’autre sans rien redessiner.
...
![Organigramme réalisé dans Rolebase, chaque rôle affichant sa raison d'être, son domaine et ses redevabilités](./organigramme-20-2-.png)
