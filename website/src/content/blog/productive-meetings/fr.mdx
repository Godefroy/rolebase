...
Une bonne partie des points d'un ordre du jour passent très bien dans un message écrit. Les remontées d'avancement en font partie, les annonces aussi, les partages de chiffres également. Réservez la synchronie aux sujets où les gens ont besoin de se répondre : un arbitrage contesté, un sujet neuf que personne ne sait encore formuler, une tension entre deux personnes.
