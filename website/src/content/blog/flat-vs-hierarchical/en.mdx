...
Functional groups people by discipline, divisional splits the company by product, market or geography, and [a matrix](/en/blog/matrix-organizational-structure) ties one person to two lines at once. Each form, what it buys and where it breaks, is covered in [the guide to organizational structure types](/en/blog/organizational-structures).
