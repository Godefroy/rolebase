...
Une structure hiérarchique range les gens sur des niveaux, chacun rendant compte à un responsable du niveau au-dessus. L’autorité descend le long de cette ligne hiérarchique. Une question monte jusqu’à quelqu’un dont le périmètre la couvre. La réponse redescend ensuite par le même chemin. Presque toute organisation garde une part de hiérarchie, donc ce qui compte, c’est le nombre de niveaux qu’elle empile et ce que décide chacun d’eux.

Une structure se décrit avec deux nombres. Le premier est le nombre de niveaux entre la personne qui exécute et celle qui arbitre en dernier ressort. Le second, l’empan de contrôle, est le nombre de personnes qui rendent compte à un même responsable. Les deux varient en sens inverse : à effectif constant, élargir les empans supprime des niveaux.

L’expression « structure hiérarchique » désigne en général une structure haute, avec beaucoup de niveaux et des empans étroits. Une structure plate a peu de niveaux et des empans larges. Le mot « plat » décrit seulement le nombre de niveaux. Une organisation plate peut très bien avoir un fondateur qui tranche sur tout, ce qui est la forme la plus concentrée de hiérarchie qui soit.

Le style de management varie indépendamment du nombre de niveaux. Une pyramide peut fonctionner avec des managers qui délèguent beaucoup, et une organisation plate avec un dirigeant qui garde tous les arbitrages. Le [management horizontal et le management vertical](/fr/blog/horizontal-vs-vertical) se distinguent par ce style. Cet article porte sur la forme de l’organigramme et sur l’endroit où se prennent les décisions.

## Structure plate ou structure haute

Une structure plate garde deux ou trois niveaux entre la personne qui exécute et celle qui arbitre en dernier ressort, avec un groupe large sous chaque responsable. Une structure haute empile davantage de niveaux et confie à chaque responsable un groupe restreint. Plate ou haute décrit seulement le nombre de niveaux. La manière de regrouper le travail se choisit à part. Regrouper les gens par métier donne une structure fonctionnelle, découper l’entreprise par produit, marché ou zone géographique donne une structure divisionnelle, et [une structure matricielle](/fr/blog/matrix-organizational-structure) rattache une même personne à deux lignes à la fois. [Chaque manière de regrouper le travail](/fr/blog/organizational-structures) a ses points forts et son point de rupture. N’importe quel regroupement fonctionne avec n’importe quel nombre de niveaux. Une entreprise fonctionnelle de trente personnes a deux niveaux, un groupe divisionnel de cinquante mille en a dix, et on trouve des structures matricielles aux deux tailles.

Qui décide se choisit à part, quel que soit le nombre de niveaux ou le regroupement. Une entreprise fonctionnelle peut laisser chaque direction trancher seule sur son domaine, ou faire remonter le moindre arbitrage. Un groupe divisionnel peut donner à ses patrons de division un vrai mandat, ou un budget à exécuter. Les droits de décision changent la journée des gens bien plus que la forme de l’organigramme.

### Les organisations non hiérarchiques

Une organisation non hiérarchique garde peu de rangs fixes et répartit l’autorité par domaine. La personne qui fixe les prix n’a pas forcément son mot à dire sur les recrutements, qui relèvent d’un autre rôle. Le contraire d’une hiérarchie s’appelle une hétérarchie, un mot que le neurophysiologiste Warren McCulloch a forgé en 1945 pour un réseau où aucun élément ne se place durablement au-dessus des autres. Les structures plates, la sociocratie et l’holacratie vont toutes dans ce sens. La sociocratie et l’holacratie emboîtent encore des cercles les uns dans les autres, mais chaque rôle y décide seul sur son domaine.

## Les apports de la hiérarchie
...
Elle dessine une trajectoire lisible. Les niveaux forment une progression que les gens comprennent, avec un titre, un périmètre et un salaire à chaque niveau. Les organisations plates doivent inventer autre chose à la place, et beaucoup s’y cassent les dents.
...
## La structure écrite remplace les niveaux
...
<FaqItem question="Une structure plate supprime-t-elle les chefs ?">
  Elle supprime des niveaux de management. L’autorité, elle, se déplace vers des rôles nommés ou vers un pouvoir informel que personne n’a désigné. Jo Freeman décrivait dès 1972 comment l’absence de structure écrite installe une élite sans responsabilité devant le groupe.
</FaqItem>
