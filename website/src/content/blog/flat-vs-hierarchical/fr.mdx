...
La fonctionnelle regroupe les gens par métier, la divisionnelle découpe l’entreprise par produit, marché ou zone géographique, et [la matricielle](/fr/blog/matrix-organizational-structure) rattache une même personne à deux lignes à la fois. Chaque forme, ce qu’elle apporte et là où elle casse, est traitée dans [le guide des types de structure](/fr/blog/organizational-structures).
