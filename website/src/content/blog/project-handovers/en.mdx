---
title: "How to make project handovers between teams efficient"
h1: "How to actually make project handovers between teams efficient"
summary: "Passing the baton between teams is often tricky. A four-step method to hand a project over with its context, its owners and its decisions intact."
date: 2026-02-17
image: './thumbnail.jpg'
...
![A project-based org chart in Rolebase, where each project holds the roles it needs](./project-based-20org-20chart-201.png)
...
4. Once the above information is clarified, Rolebase allows both teams to project-manage the handover seamlessly :
   ...
   - Discussions can be created to ease exchanges between the project members. These discussions can be updated with polls, to-dos, and any decisions that have been taken.
