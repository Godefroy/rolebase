...
## L'ordre du jour qui nourrit le compte rendu

Un compte rendu se rédige bien plus vite quand l'ordre du jour a déjà la forme que le compte rendu prendra. Envoyez l'ordre du jour avant la réunion, avec une ligne par point, et donnez à chaque point son résultat attendu. Nos [modèles d'ordre du jour](/fr/blog/meeting-agenda-template) traitent ce sujet en profondeur, avec un téléchargement Word et un modèle par type de réunion.
