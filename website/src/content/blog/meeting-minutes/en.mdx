...
## The Agenda That Feeds the Minutes

Minutes are far easier to write when the agenda already has the structure the minutes will take. Send the agenda before the meeting, with one line per item, and give every item the outcome it needs. Our [meeting agenda templates](/en/blog/meeting-agenda-template) cover the agenda side in depth, with a Word download and a template per meeting type.
