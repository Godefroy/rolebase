...
The liberated company is one of the most discussed management ideas in Europe and one of the vaguest. This article separates what researchers actually observed from what the promise implies, then describes what organisations do when autonomy lasts past year three.
...
| Holds when the founder leaves | Poorly | Well, the rules outlive the people |
