...
takeaways:
  ...
  - "Laisser chaque direction se différencier fortement ne marche que si des rôles de liaison et des instances d’arbitrage les tiennent ensemble. Les entreprises qui font l’un sans l’autre sont moins performantes que celles qui font les deux."
...
Elle fonctionne quand les deux lignes disposent d’une règle explicite pour le cas où elles ne sont pas d’accord. Sans cette règle, le conflit atterrit sur la personne qui dépend des deux. Un arbitrage qui réclame deux signatures peut alors être bloqué par l’une ou l’autre ligne, ce que Stanley Davis et Paul Lawrence, auteurs du livre de référence sur la forme en 1977, appelaient l’étranglement décisionnel dans la *Harvard Business Review* de mai 1978. Les variantes faible, équilibrée et forte, les neuf façons dont la forme déraille et ce qu’une entreprise peut écrire plutôt que recruter un second manager sont traités dans [l’article sur la structure matricielle](/fr/blog/matrix-organizational-structure).

## La structure hiérarchique

Une structure hiérarchique empile des niveaux d'autorité, chaque niveau encadrant un groupe étroit, avec une seule ligne de commandement du sommet à la base. C'est la réponse de Fayol, et elle fait tourner des entreprises depuis cent soixante-dix ans. On la dessine sous la forme d’un [organigramme hiérarchique](/fr/blog/hierarchy-chart), où chaque poste se range sous celui dont il dépend.
