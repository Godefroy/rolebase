---
title: 'Alternative à Loomio pour la gouvernance et les décisions'
h1: 'Meilleure alternative à Loomio pour la gouvernance et la prise de décision en équipe'
...
Rolebase intègre un moteur de réunion complet avec des étapes structurées : tour d'inclusion, checklists, indicateurs, revue des tâches et discussions. Les réunions suivent par défaut le format tactique et de gouvernance holacratique, mais vous pouvez personnaliser l'ordre des étapes selon votre pratique. La prise de notes collaborative se fait en temps réel, et les comptes-rendus sont automatiquement générés et archivés. Au lieu de transférer les décisions de Loomio vers un outil de réunion séparé, tout vit au même endroit.
...
### Des discussions et sondages rattachés aux rôles

Comme Loomio, Rolebase prend en charge les discussions asynchrones avec mise en forme enrichie et sondages. La différence essentielle est que chaque discussion appartient à un rôle spécifique, ce qui lui donne un contexte organisationnel. En ouvrant un rôle dans Rolebase, vous voyez toutes ses discussions, tâches, décisions et réunions au même endroit. Les discussions sont ainsi automatiquement organisées par la partie de l'organisation qu'elles concernent.

Les sondages prennent en charge le choix multiple, la répartition de points, le vote anonyme et l'ordre aléatoire des options. Ils fonctionnent bien pour la prise de décision par consentement : vous pouvez créer un sondage avec des options comme "Consentement", "Objection" et "Se retirer" pour mener des tours de consentement formels directement dans une discussion.

Les discussions progressent à travers des statuts clairs (Préparation, Actif, Bloqué, Fermé) et peuvent inclure des membres supplémentaires d'autres rôles pour la collaboration inter-équipes. Elles sont abordées lors de l'étape Discussions des réunions de rôle, créant un pont naturel entre échange asynchrone et prise de décision synchrone. Cette intégration garantit que les points discutés de manière asynchrone pendant la semaine sont automatiquement revus lors de la prochaine réunion, évitant que des sujets importants passent à la trappe.
...
| --- | --- | --- |
| Discussions asynchrones | Oui, avec texte enrichi et chronologie | Oui, avec texte enrichi et contexte de rôle |
...
| Organigramme visuel | Non | Oui, interactif avec 3 vues |
...
- Vous souhaitez des réunions structurées avec agendas collaboratifs et notes automatiques
...
5. **Utilisez les discussions.** Migrez vos discussions en cours de Loomio vers les discussions Rolebase, en les rattachant aux rôles concernés. Chaque conversation gagne ainsi un contexte organisationnel qu'elle n'avait peut-être pas auparavant.
