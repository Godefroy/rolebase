...
On peut dessiner un organigramme hiérarchique avec Word, PowerPoint ou Excel, grâce à SmartArt. Construire [un organigramme sur Word](/fr/blog/org-chart-word) demande quelques clics dans la galerie SmartArt, moins encore en partant d’un modèle à télécharger. Cela suffit pour une entreprise de vingt personnes qui changent rarement de rôle.
...
Ouvrez l’onglet Insertion, choisissez SmartArt, puis la catégorie Hiérarchie, et sélectionnez la disposition Organigramme. Saisissez les noms dans le volet Texte et utilisez Ajouter une forme pour créer des subordonnés ou un assistant. Dessiner [l’organigramme entier sur Word](/fr/blog/org-chart-word) prend une dizaine de minutes, moins si vous partez d’un modèle prêt à télécharger. PowerPoint et Excel proposent les mêmes dispositions SmartArt. L’organigramme reste un dessin que vous modifiez à la main à chaque changement dans l’organisation.
