...
You can draw a hierarchy chart in Word, PowerPoint or Excel with SmartArt (Insert, then SmartArt, then Hierarchy). The layout is ready in minutes, which is enough for a company of twenty people who rarely change roles.
...
Yes. In Word, open the Insert tab, choose SmartArt, then the Hierarchy category, and pick the Organization Chart layout. Type the names in the text pane and use Add Shape to create subordinates or assistants. PowerPoint and Excel offer the same SmartArt layouts. The chart stays a drawing, so you edit it by hand each time the organization changes.
