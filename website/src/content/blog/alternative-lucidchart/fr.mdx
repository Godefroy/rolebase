...
### Trois vues des mêmes données

Vous choisissez le type d'affichage, et un clic suffit pour en changer. Cercles imbrique chaque rôle dans son parent. Arbre hiérarchique donne l'organigramme descendant classique. Trombinoscope montre les personnes sans les rôles. Vous pouvez aussi replier l'affichage pour ne garder qu'un rôle, ses parents et ses rôles directs, ce qui garde une grande organisation lisible. Dans un outil de schémas, chacun de ces affichages serait un fichier séparé à redessiner et à tenir à jour.
...
| Vues de la même structure | Une mise en page par document | 3 vues intégrées |
