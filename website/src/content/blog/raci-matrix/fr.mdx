...
Un RACI couvre un projet et emporte sa connaissance avec lui quand le projet se termine. Un rôle survit au projet comme à la personne qui le tient. L'article sur [comment écrire un rôle](/fr/blog/define-roles) en donne le format, et [rôle ou fiche de poste](/fr/blog/roles-vs-job-descriptions) explique pourquoi un organigramme de postes ne répond jamais à la même question.
