...
Un RACI couvre un projet et emporte sa connaissance avec lui quand le projet se termine. Un rôle reste en place quand le projet se termine et quand la personne change. On remplit aussi un RACI pour rattraper une [structure matricielle](/fr/blog/matrix-organizational-structure), où la question permanente de qui tranche entre la ligne métier et la ligne produit n’a aucune réponse écrite. Ce rattrapage disparaît lui aussi avec le projet. L’article sur [comment écrire un rôle](/fr/blog/define-roles) en donne le format, et [rôle ou fiche de poste](/fr/blog/roles-vs-job-descriptions) explique pourquoi un organigramme de postes ne répond jamais à la même question.
