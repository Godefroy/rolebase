...
7. Support the middle managers first. They lose the most footing, and they decide whether the transformation holds. A manager whose position is removed without another one offered will defend the old one, which is rational.
